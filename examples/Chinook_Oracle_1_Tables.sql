...
CREATE TABLE Album
(
    AlbumId NUMBER GENERATED BY DEFAULT AS IDENTITY(),
...
CREATE TABLE Artist
(
    ArtistId NUMBER GENERATED BY DEFAULT AS IDENTITY(),
    Name VARCHAR2(120),
...
CREATE TABLE Genre
(
    GenreId NUMBER GENERATED BY DEFAULT AS IDENTITY(),
    Name VARCHAR2(120),
...
(
    InvoiceId NUMBER GENERATED BY DEFAULT AS IDENTITY(),
...
(
    InvoiceLineId NUMBER GENERATED BY DEFAULT AS IDENTITY(),
...
(
    MediaTypeId NUMBER GENERATED BY DEFAULT AS IDENTITY(),
    Name VARCHAR2(120),
...
(
    PlaylistId NUMBER GENERATED BY DEFAULT AS IDENTITY(),
    Name VARCHAR2(120),
...
CREATE TABLE Track
(
    TrackId NUMBER GENERATED BY DEFAULT AS IDENTITY(),
